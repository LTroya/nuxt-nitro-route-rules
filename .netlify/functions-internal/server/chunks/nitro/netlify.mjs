...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routeRules":{"/__nuxt_error":{"cache":false},"/posts":{"static":true,"cache":{"static":true}},"/posts/**":{"swr":20,"cache":{"swr":true,"maxAge":20}}},"envPrefix":"NUXT_"},"public":{}};
...
const _lazy_fJNx06 = () => import('../date.mjs');
const _lazy_idp0Ix = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/date', handler: _lazy_fJNx06, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_idp0Ix, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_idp0Ix, lazy: true, middleware: false, method: undefined }
];
